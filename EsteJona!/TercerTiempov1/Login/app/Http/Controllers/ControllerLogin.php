...
class ControllerLogin extends Controller
{
  ...
  $listauser = DB::table('users')->orderBy('id','ASC')
        ...
        $modalidad =  Modalidad::orderBy('id','ASC')->pluck('Modalidad','id');
           ...
           $cantidad = Evento::where('evento.users_id', '=', Auth::user()->id)
        ...
        return view('vistas.Perfiles.PerfilAdmin',['user' =>$user, 'categoria'=>  $categoria, 'modalidad'=>  $modalidad, 'campeonato'=>  $campeonato, 'ligas' => $cantidad]);
