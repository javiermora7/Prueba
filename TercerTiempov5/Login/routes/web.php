...
/*
Route::get('verificar2/{id}', 'ModuloEventoController@verificar')->name('verificar2');

Route::get('/verificar2/{id}', array(   //configuramos los datos a enviar a paypal y le paso el id de la publicación
	'as' => '/verificar2',
	'uses' => 'ModuloEventoController@verificar2',
));*/
