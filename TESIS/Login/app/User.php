...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
         'Nombres', 'Apellidos','Rut', 'Telefono','email','password','Direccion', 'NombreFacturacion','RutFactiracion','DireccionFacturacion','TipoUsuario_id','FotoPerfil','EstadosActivo_id'
    ];
