...
class Evento extends Model
{
   ...
   protected $fillable = ['Nombre','Direccion', 'FechaInicio', 'Cupos', 'Region', 'Comuna', 'Descripcion', 'Fotografia',  'RangoEdadMin', 'RangoEdadMax', 'users_id', 'EstadosActivo_id', 'Categorias_id', 'Modalidad_id','NotiMotivo', 'NotiEstado'];
