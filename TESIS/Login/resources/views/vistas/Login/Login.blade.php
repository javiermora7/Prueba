      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="p-3">
            ...
            <p class="text-mmuted text-center">Ingresa para conocer una nueva forma de administrar tus campeonatos</p>
       <!--lo de abajo captura los errores de inicio de sesion-->
        ...
        @endif
              ...
              <div class="form-group">
                ...
                <input class="form-control"  type="text" title ='Ingrese nombre de usuario' required="" name="email" id="inputEmail" placeholder="Nombre de Usuario">
              </div>

              <div class="form-group">
                <label for="userpassword">Contraseña</label>
        <input class="form-control" name="password" title ='Ingrese contraseña' required="" d="inputPassword" type="password">
              </div>
              ...
              <div class="form-group row mt-20">
                <div class="col-sm-6 text-right"><a href="{{route('PassIndex')}}"><i class="mdi mdi-lock"></i>¿Olvidó contraseña?</a></div>
