                          ...
                          <div class="text-center text-lg-left">
                            <div class="d-block d-lg-flex align-items-center">
                              ...
                              <div class="text order-1 w-100">
                                ...
                                @if($f->equipo1G==null)
                                @elseif($f->equipo1G==1)
                                  <div class="p-3 mb-2 bg-success text-white">Ganador</div>
                                @elseif($f->equipo1G==0)
                                <div class="p-3 mb-2 bg-secondary text-white">Perdedor</div>
                                @elseif($f->equipo1G==2)
                                <div class="p-3 mb-2 bg-primary text-white">Empate</div>
                               

                                @endif
                                <hr>
                                <h3 class="h5 mb-0 text-black">{{$f->equipo1}}</h3>
                        ...
                        <div class="col-md-4 col-lg-4 text-center mb-4 mb-lg-0">
                            <div class="d-inline-block">
                                ...
                                <div class="bg-black py-2 px-4 mb-2 text-white d-inline-block rounded">
                                  ...
                                  <div class="py-2 px-4 mb-2 text-white d-inline-block rounded">
                                      {!! Form::open(['route'=> 'IniciarPartido','id'=> 'CrearEvento', 'enctype'=>'multipart/form-data' , 'class'=>'form-horizontal','method' => 'POST']) !!}
                                      @csrf
                                              
                                      <input id="" name="users_id" type="hidden" value={{ Auth::user()->id}}>
                                      <input type="hidden" value="{{$evento->id}}" name="idEvento">
                                      <input type="hidden" value="{{$f->idencuentro}}" name="idEncuentro">
                                      <input type="hidden" value="{{$f->id}}" name="EquipoEncuentro">
                                      <input type="hidden" value="{{$f->fecha}}" name="fecha">
                                      <button class="btn btn btn-outline-success">Iniciar Partido</button>
                                  ...
                                  <div class="py-2 px-4 mb-2 text-white d-inline-block rounded">
                                      {!! Form::open(['route'=> 'ResultadoEncuentro','id'=> 'CrearEvento', 'enctype'=>'multipart/form-data' , 'class'=>'form-horizontal','method' => 'POST']) !!}
                                      @csrf
                                              
                                      <input id="" name="users_id" type="hidden" value={{ Auth::user()->id}}>
                                      <input type="hidden" value="{{$evento->id}}" name="idEvento">
                                      <input type="hidden" value="{{$f->idequipo1}}" name="idEquipo1">
                                      <input type="hidden" value="{{$f->idequipo2}}" name="idEquipo2">
                                      <input type="hidden" value="{{$f->idencuentro}}" name="idEncuentro">
                                      <input type="hidden" value="{{$f->id}}" name="EquipoEncuentro">
                                      <input type="hidden" value="{{$f->fecha}}" name="fecha">
                                      <input type="hidden" value="{{$f->equipo1}}" name="equipo1">
                                      <input type="hidden" value="{{$f->equipo2}}" name="equipo2">
                                      
                                      <button class="btn btn btn-outline-success">Ingresar resultado</button>
                                  ...
                                  @elseif($f->estado==1)
                                  <div class="bg-black py-2 px-4 mb-2 text-white d-inline-block rounded">
                                  <span class="h5">Finalizado</span>
                                </div>
                                <hr>
                                  <div class="bg-black py-2 px-4 mb-2 text-white d-inline-block rounded">
                                  <span class="h5">{{$f->golesEquipo1}}:{{$f->golesEquipo2}}</span>
                                </div>
                                ...
                                <div id="accordion">
                                    <div class="card col-12">
                                      <div class="card-header" id="headingOne">
                                        <h5 class="mb-0">
                                          <button class="btn btn btn-outline-primary" data-toggle="collapse" data-target="#collapse-{{$f->idencuentro}}" aria-expanded="true" aria-controls="collapseOne">
                                           Detalles encuentro <i class="fas fa-arrow-circle-down"></i>
                                          </button>
                                        </h5>
                                      </div>
                                  
                                      <div id="collapse-{{$f->idencuentro}}" class="collapse " aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                          <div class="d-inline-block">
                                                
                                            <span >fecha:{{$f->FechaHora}}  Hora:{{$f->Hora}}</span>  <hr>
                                                
                                            <span >Direccion:{{$f->Direccion}}</span>  <hr>
                                             
                                              @if($f->Direccion!=Null)
                                            <span>Cancha:{{$f->cancha}}</span>  <hr>
                                              @endif
                                              <span>Arbitro:</span>
                          ...
                          <div class="">
                            <div class="d-block d-lg-flex align-items-center">
                              ...
                              <div class="text order-1 w-100">
                                ...
                                @endif
                                <hr>
                                <h3 class="h5 mb-0 text-black">{{$f->equipo2}}</h3>
