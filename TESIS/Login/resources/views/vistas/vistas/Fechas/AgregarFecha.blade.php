    ...
    <div id="wrapper">
      ...
      <div class="left side-menu">
        ...
        <i class="far fa-futbol"></i>
          <span>Equipos</span></a>
        <a class="waves-effect" id="activarRegistro" href="#">
...
{!! Form::open(['route'=> '','id'=> 'CrearEvento', 'enctype'=>'multipart/form-data' , 'class'=>'form-horizontal','method' => 'POST']) !!}
  <div class="row">
                      <div class="col-md-4">
    ...
    {!! Form::date('FechaInicio', null, ['class'=>'form-control', 'required', 'placeholder'=>'**/**/****'])!!}
       ...
       <article class="form-group">
      {!! Form::label('DuracionPartido', 'Duración de partidos')!!}
    {!! Form::time('DuracionPartido', null, ['class'=>'form-control', 'required', 'placeholder'=>''])!!}
      </article>     
      <article class="form-group">
      {!! Form::label('LapsoPartidos', 'Lapso de partidos')!!}
    {!! Form::time('LapsoPartidos', null, ['class'=>'form-control', 'required', 'placeholder'=>''])!!}
      </article>      
  </div>   
  <div class="col-md-4">
  <article class="form-group">
...
<div id="content" style="display: none;">
 <article class="form-group">
    {!! Form::label('CantidadCancha', 'Cantidad de canchas')!!}
    {!! Form::number('CantidadCancha', null, ['class'=>'form-control', ])!!}
</article>
<article class="form-group">
    {!! Form::label('CantidadPartidos', 'Cantidad de partidos diarios')!!}
    {!! Form::number('CantidadPartidos', null, ['class'=>'form-control', ])!!}
</article>
  
 <article class="form-group">
  {{-- aca cargo los dias a jugar jona --}}
    {!! Form::label('DiasPartidos', 'Ingrese los días a jugar')!!}
