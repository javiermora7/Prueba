 ...
 <script src="{{ asset('js/demo/chart-area-demo.js') }}"> </script>
	   ...
	   <!-- abajo lo de las modales-->
     <script src="{{ asset('/js/jquery-1.12.3.min.js') }}" type="text/javascript"></script>
     <script src="{{ asset('/js/prefixfree.min.js') }}" type="text/javascript"></script>
     <script src="{{ asset('/js/acciones.js') }}" type="text/javascript"></script>
     <script src="{{ asset('/js/regioncomuna.js') }}" type="text/javascript"></script>
<!-- -->
  <!-- listar los eventos creados-->
     <script src="{{ asset('/js/ListarEventos.js') }}" type="text/javascript"></script>
