                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                               <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Editar equipo</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p><a href="{{route('editEquipo', array(Crypt::encrypt($lista->id), $evento->id))}}" class="btn btn-primary btn-sm">Editar</a></p>
                                            </div>
                                        </div>
                                         <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <p><a href="{{route('Jugador', array(Crypt::encrypt($lista->id), $evento->id))}}" class="btn btn-primary btn-sm">Registrar</a></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Eliminar equipo</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p><a href="{{route('DeleteEquipo', array(Crypt::encrypt($lista->id), $evento->id))}}" onclick="return confirm('¿Seguro que deseas eliminar este registro?')" class="btn btn-danger btn-sm">Eliminar</a></p>
                                            </div>
                                        </div>                      
                            </div>
                        </div>
                    ...
                    <div class="card card-price">
                        ...
                        <div class="card-body">
                            ...
                            <td class="price">{!! $jugador->Ju_CantidadGoles !!}</td></tr>
                             <a href="{{route('Jugador', array(Crypt::encrypt($lista->id), $evento->id))}}" class="btn btn-primary btn-lg btn-block ">Editar</a>
                             <a href="{{route('DeleteJugador', array(Crypt::encrypt($jugador->id), $evento->id, $lista->id))}}" onclick="return confirm('¿Seguro que deseas eliminar este registro?')" class="btn btn-danger btn-lg btn-block">Eliminar</a>
                            <tr>
                            </table>             
