...
{!! Form::open(['route'=> 'equipo.store','id'=> 'signupForm', 'enctype'=>'multipart/form-data' , 'class'=>'form-horizontal','method' => 'POST']) !!}
    ...
    {!! Form::text('Pa_Nombre', null, ['class'=>'form-control',  'title' =>'Ingrese un nombre','required', 'placeholder'=>'Nombre del jugador'])!!}
     ...
     <div class="form-group">
                          ...
                          <input class="form-control" type="text" required name="Pa_Apellido" >
     </div>   
    ...
    <div class="form-group">
      ...
      <article class="form-group">
      <label for="Pa_FechaNacimiento">Fecha de nacimiento</label>
    <input class="form-control" title="Ingrese una fecha de inicio" min="<?php echo date('Y-m-d') ?>" required="" placeholder="**/**/****" name="Pa_FechaNacimiento" type="date" id="Pa_FechaNacimiento">
      </article>  
  </div>   
  ...
  <div class="col-md-4">
    ...
    {!! Form::file('Pa_img', null, ['class'=>'form-control', 'type'=>'file','accept'=>'jpg,.png', 'placeholder'=>''])!!}
    </div>
   <div class="form-group">
  ...
  <input class="form-control" type="number" required name="Ju_Numero">
   </div>
   <div class="form-group">
                        {!! Form::label('Pa_Rut', 'Rut')!!}
                        {!! Form::text('Pa_Rut', null, ['class'=>'form-control', 'required'])!!}
                    </div> 
