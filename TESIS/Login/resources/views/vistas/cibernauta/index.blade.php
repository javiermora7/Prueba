...
<html lang="en">
  ...
  <meta property="og:url"           content="http://tercertiempo.club/Login/public/index" />
  <meta property="og:type"          content="website" />
  <meta property="og:title"         content="Tercer Tiempo" />
  <meta property="og:description"   content="Una nueva forma de administrar eventos deportivos" />
  <meta property="og:image"         content="{{asset('/Componentes/assets/images/tercer.png')}}" />
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
				        ...
				        <li class="dropdown">
				        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Registrate
				        <span class="caret"></span></a>
				        <ul class="dropdown-menu">
						<li><a href="{{route('RegistroEmpresa')}}">Registrar como empresa</a></li> 
				          <li><a href="{{route('registrar')}}">Registrar usuario natural</a></li>
